...
#define SENS              0x00000000  // 1.5 = 1.0 + 0.5  //sensitivity [0..2], 0=do not remove noise, 1..2=remove noise totally
#define SENS1             0x7FFFFFFF  // 1.0
#define SENS2             0x40000000  // 0.5
